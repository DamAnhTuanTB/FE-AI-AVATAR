    ...
    <Wrapper>
      ...
      <div>
        ...
        <Content>
          ...
          any credit card(s) or other payment methods (s) in connection with any
        ...
        <Content>
          ...
          us the right and license to use, modify, perform, display, reproduce,
          and distribute such Content on and through the Service.
          <br />
          <br />
          VisionLab Inc has the right but not the obligation to monitor and edit
          all Content provided by users.
          <br />
          <br />
          In addition, Content found on or through this Service is the property
          of VisionLab Inc or used with permission. You may not distribute,
        ...
        <Content>
          ...
          <br />
          <br />
          Your VisionLab subscription will automatically renew at its expiration
          date unless you cancel it prior to your payment date. A monthly
          subscription renews after 30 days from the purchase date and an annual
          subscription renews after 365 days from the purchase date. If you
          cancel your subscription any time before your payment processing date,
          you will continue to have an active subscription until the date on
          which your next payment was scheduled. For example, if your payment is
          scheduled for the 30th, but you cancel your subscription on the 15th,
          you will still have an active subscription until the 30th.
          <br />
          <br />
          You may cancel your subscription at any time from your My Account
          page. Due to security and privacy reasons, under no circumstances will
          VisionLab cancel a subscriber’s subscription via email or phone. A
          subscription cancellation can only be made by the respective
          subscriber from their My Account page.
          <br />
          <br />
        ...
        <Content>
          The fees and other details with respect to each account are set forth
          at Account Details. VisionLab, at its sole discretion, may modify
          account fees. <br /> VisionLab will not be obligated to issue any
          refunds for any fees charged to your Credit/Debit Card/PayPal Account.
          <br />
          <br />
...
`}</SubTitle>
          ...
          <ul>
            <li>
              You are authorized to use and have fees charged to the credit card
              number, debit card number or PayPal account you provide via our
              website.
            </li>
            <li>
            ...
            <li>
              You are authorized to distribute and display all VisionLab Images
              you create via our website.
            </li>
            <li>
              All of your registration and account information is true, accurate
              and complete.
            </li>
          ...
          Any breach or suspected breach of any of the above representations or
          warranties may result in immediate termination of your account or
        ...
        <Content>
          ...
          to <a href={`mailto:dmca@VisionLab.ai`}>dmca@VisionLab.ai</a>, with
          the subject line:{' '}
        ...
        <Content>
          ...
          property of VisionLab Inc and its licensors. The Service is protected
        ...
        <Content>
          ...
          <br />
          <br />
          You acknowledge and agree that VisionLab Inc shall not be responsible
